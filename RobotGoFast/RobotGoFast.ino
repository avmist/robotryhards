...
// Chain 4 Start @ J1
// GoTask2 t4_1(&t1_3, 47.5,   "GO #1  47.5 [EAST]");
// TurnTask t4_2(&t4_1, 90.0,  "TN #1  90.0 [RIGHT]");
// GoTask2 t4_3(&t4_2, 12.5,   "GO #1  12.5 [SOUTH]");
// Chain 4 End @ J3
...
// Chain 1 Start @ Start
// StartTask root(NULL, "Start");
// GoTask2 t1_1(&root, 52,   "GO #1  52.0 [SOUTH]");
// //TurnTask t1_2(&t1_1, -90, "TN #1 -90.0 [LEFT]");
// //GoTask2 t1_3(&t1_2, 37,   "GO #1  37.0 [EAST]");
// StopTask end(&t1_1, "End");
// Chain 1 End @ J1
...
void setup() {
  ...
  // REG_TC4_COUNT16_CC0 = 500;                      // Set the TC4 CC0 register as the TOP value in match frequency mode
